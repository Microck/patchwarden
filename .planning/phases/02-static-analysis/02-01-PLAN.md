...
must_haves:
  ...
  artifacts:
    - path: "src/mod_sentinel/analysis/decompiler.py"
      provides: "Decompilation wrapper"
    - path: "src/mod_sentinel/analysis/jar_classes.py"
      provides: "Class enumeration/extraction"
  key_links:
    - from: "src/mod_sentinel/analysis/decompiler.py"
      to: "java subprocess"
...
`src/mod_sentinel/analysis/tempdirs.py` should provide a small helper for managed temp dirs for analysis runs.
  </action>
